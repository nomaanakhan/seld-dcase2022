...
# call that script update it to use the new folder

# model = CRNN(torch.nn.Module)

# # Load model weights

# loaded_model = torch.load("C:/Users/Abbas/Desktop/mlStuff/seld-dcase2022/models/1_1_dev_split0_accdoa_foa_model.h5")
