...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        pretrained_model_weights = 'models/1_1_dev_split0_accdoa_foa_model.h5', 

        # INPUT PATH
        # dataset_dir='DCASE2020_SELD_dataset/',  # Base folder containing the foa/mic and metadata folders
        dataset_dir = 'C:/Users/Spher/Desktop/sound/seld-dcase2022/',

        # OUTPUT PATHS
        # feat_label_dir='DCASE2020_SELD_dataset/feat_label_hnet/',  # Directory to dump extracted features and labels
        feat_label_dir='C:/Users/Spher/Desktop/sound/seld-dcase2022/labels',
 
        model_dir='C:/Users/Spher/Desktop/sound/seld-dcase2022/models/',            # Dumps the trained models and training curves in this folder
        dcase_output_dir='C:/Users/Spher/Desktop/sound/seld-dcase2022/results/',    # recording-wise results are dumped in this path.
